...
from newsletter.models import Message, Article, Subscription
...
class EventForm(forms.ModelForm):
    ...
    location = forms.CharField(label='Location:',
                               widget=forms.TextInput(attrs={"placeholder": "London, New York, etc."}))
...
class SubscribeNewsletterForm(forms.ModelForm):
    subscribed = forms.BooleanField(required=False, initial=False,
                                    label="I'd like to subscribe to Eventify's newsletter")
